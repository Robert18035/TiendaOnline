...
class CamisasActivity : AppCompatActivity() {
    ...
    private fun mostrarCamisas  () {
        val listaArticulos: ListView =
            findViewById(R.id.lista_camisas) as ListView
        val query: Query =
            FirebaseDatabase.getInstance()
                .reference.child("Productos").orderByChild("Categoria")  .equalTo("Camisa")     //Accesa a la base de datos
